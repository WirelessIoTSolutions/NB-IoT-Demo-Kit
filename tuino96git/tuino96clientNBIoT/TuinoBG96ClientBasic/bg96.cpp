...
uint8_t BG96_deviceIsConnected(char *operator_code)
{
  ...
  {
    Serial.println(" -> Device currently not connected to NB-IoT\n");
    return BG96_KO;
  }
  Serial.print("Device currently connected to NB-IoT Operator with OP-Code:"); Serial.println(operator_code);
  Serial.println("");
  return BG96_OK;
}
