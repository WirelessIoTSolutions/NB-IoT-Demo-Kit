...
void printOLED(int value, unsigned char Row, unsigned char Column);
void printOLED(float value, unsigned char Row, unsigned char Column);
void printOLED(String value, unsigned char Row, unsigned char Column);
void printOLED(char value[], unsigned char Row, unsigned char Column);
void printOLED(double value, unsigned char Row, unsigned char Column);
